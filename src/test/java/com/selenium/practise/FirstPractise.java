...
public class FirstPractise {
    ...
    public void test1() {
        ...
        WebElement accout = driver.findElement(By.id("inputAccount"));
        //inputPassword
        WebElement passwd = driver.findElement(By.id("inputPassword"));

        WebElement login = driver.findElement(By.className("confirmBtn"));
